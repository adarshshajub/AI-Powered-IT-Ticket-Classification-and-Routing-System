"""
Django settings for AI_Powered_IT_Ticket_Automation_System project.
...
ROOT_URLCONF = 'AI_Powered_IT_Ticket_Automation_System.urls'
...
WSGI_APPLICATION = 'AI_Powered_IT_Ticket_Automation_System.wsgi.application'
