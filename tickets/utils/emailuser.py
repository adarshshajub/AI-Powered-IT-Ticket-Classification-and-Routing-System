...
from tickets.utils.mailer import send_mail_from_account
import logging
...
def get_or_create_user_by_email(email_address, send_welcome, account_key):
    ...
    if send_welcome:
        ...
        subject = render_to_string(
            "monitor_email/new_email_user_subject.txt", ctx
        ).strip()
        text_body = render_to_string("monitor_email/new_email_user.txt", ctx)
        html_body = render_to_string("monitor_email/new_email_user.html", ctx)
