...
def send_verification_email(
    ...
    request,
    user,
    subject_template="registration/verify_email_subject.txt",
    email_template_txt="registration/verify_email.txt",
    email_template_html="registration/verify_email.html",
):
    uid = urlsafe_base64_encode(force_bytes(user.pk))
    token = default_token_generator.make_token(user)
...
def send_email_reply(
    ...
    to_email,
    subject,
    subject_template="monitor_email/replay_email_subject.txt",
    email_template_txt="monitor_email/replay_email.txt",
    email_template_html="monitor_email/replay_email.html",
):
